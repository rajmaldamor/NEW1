...
# ╔═╡ 954bdbcd-60ab-429b-9da5-025a605a52c9
begin
	using DataFrames
	using CSV
end

# ╔═╡ 8c97f5ed-c792-4bd9-bf1d-afb1bd348806
using Plots  # This will install plots

# ╔═╡ cb791dad-e8bc-47d3-a2bc-f5baf72ae695
using PlutoUI

# ╔═╡ df3f453c-1c1f-41cb-a761-0ed9081bfe6c
df = CSV.read("WHO-COVID-19-global-data.csv", DataFrame)

# ╔═╡ ce75b5f6-f6d5-4ccb-b543-8b1cf9500222
equals_sg(x::AbstractString) = x == "SG"

# ╔═╡ fe6ec233-a79c-4a64-a25d-c9f9a8cabdf4
sg_data = filter(:Country_code => equals_sg, df)

# ╔═╡ 94b1d343-c6a4-4527-8b22-ddbdfa4f0e36
dates = sg_data[!, "Date_reported"]

# ╔═╡ 7f83c8a5-02b3-4f34-999c-177a1260fc10
cumulative_cases = sg_data[!, "Cumulative_cases"]

# ╔═╡ a28b00f8-0322-4a33-ac88-d245cd8e2354
cumulative_data_plotted_over_date = plot(dates, cumulative_cases)

# ╔═╡ 821c8c1d-88c7-442e-8f67-272438b6c032
...
# ╔═╡ cba9836c-a93e-4226-b185-422cf5c0c390
@bind slider_value Slider(0:10:1000)

# ╔═╡ a495c64d-7a59-4799-b800-6b9e58699ac4
md"""
### Slider Value Now At $(slider_value)
"""

# ╔═╡ ad3b2d3b-3663-480b-9ccb-c09f81d5462c
@bind date_slider_index Slider(1:length(dates))

# ╔═╡ da30e92e-5fc9-4c51-9e94-75ec3fe42146
md"""
### The date is now $(dates[date_slider_index])
"""

# ╔═╡ 87783d45-363e-43cb-be66-765d7b231052
